...
1. Make sure you have the repository cloned: [Link to Repository](https://github.com/Green-Software-Foundation/carbon-aware-sdk.git)
...
- Recommended: [`jq`](https://stedolan.github.io/jq/) for parsing JSON output
