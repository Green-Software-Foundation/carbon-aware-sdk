...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CarbonAwareApi()
        api_instance.batch_forecast_data_async  # this is an instance of the class Endpoint
        api_instance.batch_forecast_data_async()  # this invokes api_instance.batch_forecast_data_async.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.batch_forecast_data_async.callable or self.callable in this class
