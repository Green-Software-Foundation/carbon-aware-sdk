...
public class electricityMapClientHttpException : Exception, IHttpResponseException
{
    /// <summary>
    /// Creates a new instance of the <see cref="electricityMapClientHttpException"/> class.
    /// </summary>
    ...
    public electricityMapClientHttpException(string message, HttpResponseMessage response) : base(message)
    {
        this.Response = response;
        this.Status = (int)response.StatusCode;
        this.Title = nameof(electricityMapClientHttpException);
        this.Detail = message;
    }
