...
namespace CarbonAware.Tools.electricityMapClient
{
    ...
    {
        /// <summary>
        /// Creates a new instance of the <see cref="electricityMapClientException"/> class.
        /// </summary>
        ...
        public electricityMapClientException(string message, HttpResponseMessage? response) : base(message)
        {
