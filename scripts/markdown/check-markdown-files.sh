...
DOCS_DIRECTORY="./docs"
EXCLUDED_DIRECTORIES="./samples|.github|./clients"
...
if [ $COUNT_OF_OUT_OF_PLACE_FILES -ge 1 ]; then
    ...
    find -iname "*md" ! -iwholename $REPO_README ! -iwholename $CONTRIBUTING_README | egrep -v $DOCS_DIRECTORY | egrep -v $EXCLUDED_DIRECTORIES
    exit 1
fi
